...
#(interaction effect of type x dispersal and type x introduction vector; Table 2). 
...
tab$type_dispersal <- paste(tab$type,tab$dispersal,sep="_")
...
###add the values for the 8 groups (dispersal*type and introduction*type)
for (i in unique(tab$type_dispersal)){
  edata = subset(tab[tab$type_dispersal==i,])
...
###add the values for the 8 groups (dispersal*type and introduction*type)
for (i in unique(tab2$type_dispersal)){
  gdata = subset(tab2[tab2$type_dispersal==i,])
...
tab2$type_dispersal <- paste(tab2$type,tab2$dispersal,sep="_")
...
###add the values for the 8 groups (dispersal*type and introduction*type)
for (i in unique(tab2$type_dispersal)){
  data = subset(tab2[tab2$type_dispersal==i,])
